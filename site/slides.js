...
window.SLIDES = (() => {
  ...
  const section = (number, title, caption) => ({
    ...
    notes: 'Tempo: 5 segundos. Anuncie a seção e avance para o conteúdo.'
  });
  ...
  return [
    {
      title: 'Planejamento discreto de redes de sensores com nós móveis', section: 'SBPO 2026', className: 'cover',
      content: html`<div class="cover-line"></div><h1>Planejamento Discreto de Redes de Sensores com Nós Móveis</h1><p class="subtitle">Via Programação Inteira Mista e Avaliação por Simulação</p><p class="author">Junio Cesar Ferreira</p><p class="affiliation">Instituto de Ciências Matemáticas e de Computação · USP</p>`,
      notes: 'Tempo: 25 segundos. Apresente o trabalho e a questão investigada: selecionar posições de nós fixos para atender dispositivos móveis, utilizando programação inteira mista e simulação.'
    },
    {
      title: 'Roteiro da apresentação', section: 'Visão geral',
      content: html`<div class="agenda"><div class="agenda-item"><span>01</span>Apresentação e contexto</div><div class="agenda-item"><span>02</span>Definição do problema</div><div class="agenda-item"><span>03</span>Modelo MILP</div><div class="agenda-item"><span>04</span>Metodologia experimental</div><div class="agenda-item"><span>05</span>Resultados</div><div class="agenda-item"><span>06</span>Considerações finais</div></div><p class="small muted">Ao final: demonstração animada das rotas de comunicação.</p>`,
      notes: 'Tempo: 20 segundos. Apresente a sequência: contexto, definição do problema, formulação matemática, metodologia, resultados e conclusões. A demonstração animada está ao final.'
    },
    section('01', 'Apresentação e contexto da pesquisa', 'Planejamento de infraestrutura para uma rede em movimento.'),
    {
      ...
      notes: 'Tempo: 45 segundos. Apresente seu vínculo e a equipe de pesquisa. O trabalho é motivado pelo desafio de projetar redes de sensores sem fio em cenários com mobilidade.'
    },
    ...
    section('03', 'Modelo MILP', 'Instalar nós, habilitar enlaces e encaminhar dados.'),
    {
      ...
      notes: 'Tempo: 65 segundos. Apresente as três decisões na ordem instalação, habilitação e fluxo. y não depende do tempo; z e x dependem. Um arco com z igual a um pode ter fluxo zero, pois não há custo direto associado à habilitação. Para analisar enlaces efetivamente utilizados, o artigo considera fluxo positivo.'
    },
    {
      ...
      notes: 'Exemplo ilustrativo acrescentado ao LaTeX original, ainda sem tempo reservado no roteiro. Mostre os dois caminhos até o sink. Os nós fixos retransmitem os dados; os valores nas setas representam a intensidade de fluxo. Não são resultados de uma nova execução.'
    },
    {
    ...
    },
    {
      ...
      notes: 'Tempo: 45 segundos. Mostre os candidatos como quadrados, o sink como estrela e as trajetórias em verde. Os círculos indicam alcance de comunicação. Os 90 metros de interferência se aplicam apenas à simulação. Esta é uma única instância controlada e os resultados devem ser interpretados nesse escopo.'
    },
    ...
    },
    {
      ...
      notes: 'Tempo: 20 segundos. Agradeça a atenção, os coautores e as agências de fomento. A demonstração animada vem a seguir. O roteiro de referência tem 15 minutos, sem contar o exemplo ilustrativo de fluxo, a demonstração e as perguntas.'
    },
    demo('Rotas de comunicação · alcance dos nós fixos', 'routes', 'A infraestrutura permanece fixa enquanto os móveis percorrem suas trajetórias.', 'Demonstração adicional, sem duração fixada no roteiro. Fonte: wsn-milp/wsn-mobile/output/routes.gif. Os círculos verdes destacam o alcance dos nós fixos instalados; os enlaces vermelhos têm fluxo positivo. Esta é uma visualização da solução do exemplo mobile, não uma animação de pacotes do Cooja nem uma nova validação dos resultados do artigo.')
  ];
})();
